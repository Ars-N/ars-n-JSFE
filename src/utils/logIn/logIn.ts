...
export function logIn(): void {
  ...
  db.getUser().then((user) => {
    ...
    ($btnHeader.querySelector('.mdc-button__label') as HTMLSpanElement).innerText = 'start game';
    ...
    reader.onload = () => {
      ...
      $btnReLog.addEventListener('click', () => {
        ($btnHeader.querySelector('.mdc-button__label') as HTMLSpanElement).innerText = 'register new player';
        // remove img + bntReLog
